...
public class Solution
{
    public static void main(String[] args)
    {
        ...
        Human child1 = new Human("Child1", true, 24, father1, mother1);
        Human child2 = new Human("Child2", true, 24, father1, mother1);
        Human child3 = new Human("Child3", true, 24, father1, mother1);
